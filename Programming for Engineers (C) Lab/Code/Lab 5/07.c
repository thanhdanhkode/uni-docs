...
int containsPair(const int faceCounts[]);
int containsTwoPairs(const int faceCounts[]);
int containsThreeOfAKind(const int faceCounts[]);
int containsFourOfAKind(const int faceCounts[]);
int containsFlush(const int suitCounts[]);
int containsStraight(const int faceCounts[]);
